...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference("Turma.count") do
      post turmas_url, params: { turma: { curso: @turma.curso, descricao: @turma.descricao, estado: @turma.estado, instituicao: @turma.instituicao } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { curso: @turma.curso, descricao: @turma.descricao, estado: @turma.estado, instituicao: @turma.instituicao } }
